...
In the editor there is a button for exporting the generated graph to a .barrier file.
...
So you can export the graph to a .barrier file, open it in your favourite 3D application, edit it, and export it to a mesh which Unity can import.
...
For blender for example, what you have to do is to first import the mesh using the .barrier importer. Don't change anything related to axes in the settings.
...
Then make the edits you need and export it as an .barrier file to somewhere in the Unity project.
