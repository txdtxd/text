/** This is a simple utility class for importing barrier files into a Unity mesh at runtime.
	        ...
	        using (StringReader reader = new StringReader(entireText))
	        {
	            ...
	            while (currentText != null)
	            {
	                ...
	                else
	                {
	                    ...
	                    switch (brokenString[0])
	                    {
	                        ...
	                        case "f":
	                            ...
	                            while (j < brokenString.Length && ("" + brokenString[j]).Length > 0)
	                            {
	                                ...
	                                if (brokenBrokenString.Length > 1)                                  //Some .barrier files skip UV and normal
	                                {
	                                    if (brokenBrokenString[1] != "")                                    //Some .barrier files skip the uv and not the normal
	                                    {
	                    ...
	                    if (currentText != null)
	                    {
	                        currentText = currentText.Replace("  ", " ");       //Some .barrier files insert double spaces, this removes them.
	                    }
	                }
	            }
	        }
