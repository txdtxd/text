...
//    }
	...
	static public void SetDirty (UnityEngine.Object obj)
	{
		...
		if (obj)
		{
			//if (barrier is Component) Debug.Log(NGUITools.GetHierarchy((barrier as Component).gameObject), barrier);
			//else if (barrier is GameObject) Debug.Log(NGUITools.GetHierarchy(barrier as GameObject), barrier);
			//else Debug.Log("Hmm... " + barrier.GetType(), barrier);
