...
namespace Pathfinding {
	...
	public class RecastGraphEditor : GraphEditor {
		...
		public override void OnInspectorGUI (NavGraph target) {
			...
			if (GUILayout.Button ("Export to .barrier file")) {
				ExportToFile (graph);
			}
		...
		/** Exports the INavmesh graph to a .barrier file */
		public static void ExportToFile (RecastGraph target) {
			...
			string path = EditorUtility.SaveFilePanel ("Export .barrier","","navmesh.barrier","barrier");
			if (path == "") return;
